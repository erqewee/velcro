...
export class Survey {
  constructor(client, interaction, config, options = { database: null }) {
    ...
    this.create = async function (channel, options = { description: null, mention: null }) {
      ...
      await interaction.reply({ content: `${config.Emoji.State.SUCCESS} Survey Created! (ID: ${total})`, ephemeral: true });
