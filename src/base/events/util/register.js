  ...
  async execute(interaction) {
    ...
    if (interaction.customId === "register") {
      ...
      const embed = new this.Embed({
        title: `${client.user.username} - ${this.translate("events.register.title")}`,
        fields: [
          {
            name: `${this.config.Emoji.Other.USER} ${this.translate("events.register.user")}`,
            value: `- ${member}`,
            inline: true
          },
          {
            name: `${this.config.Emoji.Other.NOTEPAD} ${this.translate("events.register.name")}`,
            value: `- ${name}`,
            inline: true
          },
          {
            name: `${this.config.Emoji.Other.USER} ${this.translate("events.register.employee")}`,
        ...
        footer: {
          text: `${interaction.user.tag}, ${this.translate("events.register.totalRegisterCount")} ${fetchRegCount}`
        }
      });
        ...
        new this.Row({
          components: [
            new this.Button({
              ...
              label: this.translate("events.register.editMemberName"),
