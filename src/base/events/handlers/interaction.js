...
export default class extends Handler {
     constructor() {
          ...
          this.execute = async function (interaction) {
               ...
               const command = this.commands.cache.get(interaction.commandName);

               if (command?.developer && !this.config.Data.Bot.Developers.includes(member.id)) return interaction.reply(`${this.config.Emoji.State.ERROR} ${member}, Are you developer?`);
